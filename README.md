...
7. After you have your API key, proceed to the opening a project in [IBM WatsonX](dataplatform.cloud.ibm.com). Begin with login in and selecting a region (select one option from the drop list). 
