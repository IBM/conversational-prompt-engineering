...
def run():
    ...
    if num_prompts < 1:
        ...
        baseline_prompt = build_few_shot_prompt(st.session_state.manager.baseline_prompt, [],
                                                st.session_state.manager.summarization_bam_client.parameters['model_id'])
        ...
        with col1:
            ...
            st.write(f"Using model [{st.session_state.manager.summarization_bam_client.parameters['model_id']}](https://bam.res.ibm.com/docs/models#{st.session_state.manager.summarization_bam_client.parameters['model_id'].replace('/', '-')})")
        ...
        if 'evaluation' not in st.session_state:
            st.session_state.evaluation = Evaluation(st.session_state.manager.summarization_bam_client)
