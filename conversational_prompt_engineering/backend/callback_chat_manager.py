...
class ModelPrompts:
    def __init__(self) -> None:
        ...
        self.analyze_discussion_task = \
            ...
            'Compare the model outputs to the accepted ones and give recommendations for the prompt improvement so that it would produce the accepted outputs directly.'
